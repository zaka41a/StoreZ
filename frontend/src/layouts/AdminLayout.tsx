...
import { LayoutDashboard, Users, Store, Package, ListOrdered, LogOut } from "lucide-react";
            ...
            <aside className="col-span-12 md:col-span-3 lg:col-span-2 border-r bg-white flex flex-col">
                <div className="p-6 border-b">
                    <h1 className="text-2xl font-extrabold text-brand-700 tracking-tight">
                        Admin<span className="text-yellow-400 drop-shadow-[0_0_6px_rgba(255,215,0,0.8)]">Z</span>
                    </h1>
                </div>
